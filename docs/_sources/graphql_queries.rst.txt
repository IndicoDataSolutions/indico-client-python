...
https://app.indico.io/graph/api/graphql (or equivalent w/ your company's base domain in place of 
app.indico.io). From here, you can test queries as well as see the full schema of available variables. 
